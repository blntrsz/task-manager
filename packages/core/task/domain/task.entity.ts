import { BaseEntity, baseEntity, fromPlainToClass } from "../../common/domain/entity.js";
import { z } from 'zod'
...
export class TaskEntity extends BaseEntity implements z.infer<typeof TaskEntitySchema> {
  name!: string
  description!: string
